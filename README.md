...
```bash
cargo test                                         # 270 tests, no network required
...
was read, a magnitude, and a **written falsifier**. Fifteen entries. Each magnitude below is quoted from the filing rather than summed, because

...
```bash
cargo test                                         # 275 tests, no network required
...
was read, a magnitude, and a **written falsifier**. Twenty entries. Each magnitude below is quoted from the filing rather than summed, because
